        ...
        <div class="widget-content">
            ...
            <div class="tabbable">
                <ul class="nav nav-tabs">
                    ...
                    <li class="active"><a href="#jscontrols" data-toggle="tab">JS Controls</a>
                    </li>
                </ul>
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="td-actions"><a href="javascript:;" class="btn btn-small btn-success"><i class="btn-icon-only icon-ok"> </i></a><a href="javascript:;" class="btn btn-danger btn-small"><i class="btn-icon-only icon-remove"> </i></a>
                        </td>
                    </tr>
                </tbody>
            </table>
